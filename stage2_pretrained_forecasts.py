...
states, performs fold-local text encoding and Optuna model selection, refits
on all labeled training rows, evaluates 2022 and 2023 separately, and writes
one 52,000-row submission CSV per fitted model.
"""
...
OUTPUT_DIR = (
    ...
    / "timesfm_covariate_residual_fusion"
)
PRICE_CACHE_DIR = (
    ARTIFACT_DIR
    / "stage2_pretrained_forecasts"
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--force-model-refresh",
        action="store_true",
        help="Regenerate text and model artifacts.",
    )
...
def main() -> None:
    ...
    results = run_walk_forward_fusion(
        ...
        seed=RANDOM_STATE,
        run_training=True,
        force_refresh=args.force_model_refresh,
    )
