...
The selected sequence is passed through an LSTM, a gated residual connection,
and multi-head temporal self-attention. Left padding is masked, and the final
time step is refined with the static context:
...
\left(\operatorname{LSTM}(s_{i,t-31:t})\right)_{-1},
c_{i,t}
\right).
\end{equation}
