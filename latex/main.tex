...
After the price history has been encoded, either price encoder can be paired
with each of the same three text-fusion choices:
...
\begin{enumerate}
    \item frozen TimesFM representation plus classification head;
